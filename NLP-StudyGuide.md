...
### top-k / top-p / Sampling 
 ...
 5. InstructGPT: scaling up RLHF
  - Instruction Fine-tuning; 
  - Human preferences from comparison data; 
  - Optimize a policy against a reward model using RL
  ![RF](./Pics/RF.png)
...
5. Dropout reduces overfitting by introducing stochastic noise during training. Dropout is only applied during training.(reducing epochs (Early Stopping), adjusting learning rates, and adding Dropout)
